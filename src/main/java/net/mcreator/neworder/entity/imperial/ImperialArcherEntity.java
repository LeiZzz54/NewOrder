...
public class ImperialArcherEntity extends PathfinderMob {
	public ImperialArcherEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(NewOrderModEntities.IMPERIAL_ARCHER.get(), world);
	}

	public ImperialArcherEntity(EntityType<ImperialArcherEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		NewOrderRightClickProcedure.execute(entity, sourceentity);
		return retval;
	}
